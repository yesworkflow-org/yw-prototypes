...
annotation(38, 1, 75, '@param', 'rejected_sample').
...
annotation(45, 1, 92, '@param', 'accepted_sample').
annotation(46, 1, 93, '@param', 'num_images').
annotation(47, 1, 94, '@param', 'energies').
...
annotation(69, 1, 133, '@end', 'transform_images').
annotation(70, 1, 137, '@begin', 'log_average_image_intensity').
annotation(71, 1, 138, '@param', 'cassette_id').
annotation(72, 1, 139, '@param', 'sample_id').
annotation(73, 1, 140, '@param', 'frame_number').
annotation(74, 1, 141, '@in', 'total_intensity').
annotation(75, 1, 142, '@in', 'pixel_count').
annotation(76, 1, 143, '@in', 'corrected_image_path').
annotation(77, 1, 144, '@out', 'collection_log').
annotation(78, 1, 144, '@uri', 'file:run/collected_images.csv').
annotation(79, 1, 152, '@end', 'log_average_image_intensity').
annotation(80, 1, 156, '@end', 'simulate_data_collection').
annotation(81, 1, 160, '@begin', 'collect_next_image').
annotation(82, 1, 161, '@param', 'cassette_id').
annotation(83, 1, 162, '@param', 'sample_id').
annotation(84, 1, 163, '@param', 'num_images').
annotation(85, 1, 164, '@param', 'energies').
annotation(86, 1, 165, '@param', 'image_path_template').
annotation(87, 1, 166, '@return', 'energy').
annotation(88, 1, 167, '@return', 'frame_number').
annotation(89, 1, 168, '@return', 'intensity').
annotation(90, 1, 169, '@return', 'raw_image_path').
annotation(91, 1, 182, '@end', 'collect_next_image').
annotation(92, 1, 186, '@begin', 'transform_image').
annotation(93, 1, 187, '@param', 'raw_image_path').
annotation(94, 1, 188, '@param', 'corrected_image_path').
annotation(95, 1, 189, '@param', 'calibration_image_path').
annotation(96, 1, 190, '@return', 'total_intensity').
annotation(97, 1, 191, '@return', 'pixel_count').
annotation(98, 1, 212, '@end', 'transform_image').
