...
%  @in ev @as effect_variable
%  @out ev @as Keffect_variable
...
%  @out predrought_effect @as predrought_effect_variable
%  @out drought_value @as drought_value_variable
%  @out recovery_time @as recovery_time_variable
%  @out drought_number @as drought_number_variable
...
%  @in recovery_time @as recovery_time_variable
%  @out ‘RecoveryTime.png’ @as output_recovery_time_figure
...
%  @in drought_value @as drought_value_variable
%  @out ‘DroughtVariable.png’ @as output_drought_value_variable_figure
do_figure('max',14,'lucida sans unicode');
subplot(2,1,1);
tmp=drought_value;
...
%  @in predrought_effect @as predrought_effect_variable
%  @out “PredroughtEffectVariable.png“ @as output_predrought_effect_variable_figure
do_figure('max',14,'lucida sans unicode');
subplot(2,1,1);
...
%  @in drought_number @as drought_number_variable
%  @out “DroughtNumber.png“ @as output_drought_number_figure
do_figure('max',14,'lucida sans unicode');
subplot(2,1,1);
tmp=drought_number;
